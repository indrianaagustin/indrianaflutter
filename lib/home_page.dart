...
class HomePage extends StatefulWidget {
  ...
  const HomePage({super.key, required this.onThemeChanged, required this.isDark});
...
class _HomePageState extends State<HomePage> {
  ...
  void _filterTasks() {
    ...
    setState(() {
      filteredTasks = tasks.where((task) => task.toLowerCase().contains(query)).toList();
    });
  }
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () async {
                              final editController = TextEditingController(text: filteredTasks[index]);
